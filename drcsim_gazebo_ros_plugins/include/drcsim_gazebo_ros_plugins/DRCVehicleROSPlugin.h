...
namespace gazebo
{
  class DRCVehicleROSPlugin: public DRCVehiclePlugin
  {
    ...
    /// \brief 
    public: void SetWaypointState(const geometry_msgs::Point::ConstPtr &_msg);

    /// \brief Sets the speed
    /// \param[in] _msg Desired speed as Float64 message
    public: void SetSpeedState(const std_msgs::Float64::ConstPtr &_msg);
    ...
    /// \brief Returns the current odometry of the vehicle by a nav_msg
    public: nav_msgs::Odometry GetOdometry();
    ...
    ///        the range of travel.
    /// \param[in] _percent Double representing desired percent.
    public: void SetHandBrakePercent(double _percent);
    ...
    private: ros::Publisher pubOdometry;
    //private: ros::Publisher pubSpeedState;
    //private: ros::Publisher pubHeadingState;
    //private: ros::Publisher pubHeadingError;
    //private: ros::Publisher pubCrossTrackState;
    //private: ros::Publisher pubCrossTrackError;
    ...
    private: ros::Subscriber subSpeedCmd;
    //private: ros::Subscriber subWaypointCmd;
